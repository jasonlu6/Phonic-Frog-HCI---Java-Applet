...
public class PhonicIviewConsole extends JFrame implements MouseListener {
	
	/**
	 * Constructor to build the view of the GUI assignment. 
	 */
	public PhonicIviewConsole(Color colorGui, Color textGui, String input, String[] phonics, int words) {
